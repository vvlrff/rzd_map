            ...
            <div className={s.container}>
                <Link to="/data" className={s.link}>
                    <div className={s.left_block}>
                        <div className={s.text}>Просмотреть все данные</div>
                        <img
                            src={dataLogo}
                            className={s.dataLogo}
                            alt="Логотип бд"
                        ></img>
                    </div>
                </Link>
                ...
                <Link to="/map" className={s.link}>
                    <div className={s.right_block}>
                        <div className={s.text}>Карта</div>
                        <img
                            src={mapLogo}
                            className={s.mapLogo}
                            alt="Логотип карты"
                ...
                <div className={s.link} onClick={() => collectNews()}>
                    <div className={s.lower_block}>
                        <div className={s.text}>Собрать данные</div>
                        <img
                            src={calendarLogo}
                            className={s.calendarLogo}
